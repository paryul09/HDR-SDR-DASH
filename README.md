...
- **FFmpeg**: Required for transcoding, watermarking, and converting HDR videos to SDR.
  ```bash
  sudo apt-get install ffmpeg
  ```

- **libzimg-dev**: This library is required for the zscale filter used in HDR to SDR conversion.
  ```bash
  sudo apt-get install libzimg-dev
  ```

- **Bento4**: Required for fragmenting videos and creating DASH manifests. You can download and install Bento4 from [here](https://www.bento4.com/).
